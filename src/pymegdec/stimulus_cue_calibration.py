...
def _fit_cue_calibrated_outer_fold_model(  # pylint: disable=too-many-arguments,too-many-locals
    ...
    *,
    ...
    train_features, feature_transform_metadata = cross_subject._fit_training_feature_transform(  # pylint: disable=protected-access
        train_features,
        train_main_sets,
        decode_config,
    )
...
def _cue_output_decode_config(decode_config, calibration_config):
    return replace(decode_config, alignment=calibration_config.alignment)
